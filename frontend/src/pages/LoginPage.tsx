...
export function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (mode === 'signin') {
        ...
        // On success, auth state change listener will update user, causing redirect
      } else {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Otherwise, browser is redirected to Google OAuth flow
  };
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.brand}>
          ...
          <h1 className={styles.brandName}>BrainHeal</h1>
          <p className={styles.brandTagline}>Your bookmarks, distilled.</p>
        </div>
