0a. Study specs/*.md to learn about the project.

1. Your goal is to implement the read-next feature.
...
1000. ALWAYS KEEP the specs, the AGENT.md, the README.md, and the rules at cursor/rules/* up to do date with your learnings using a subagent. Especially after wrapping up/finishing your turn.
